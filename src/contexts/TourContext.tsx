...
export const TOUR_STOPS: TourStop[] = [
  ...
  },
  {
    ...
    body: "Invite friends with your personal link. When a friend plays their first match you get +500 XP. No limit.",
    icon: "👥",
  },
  {
    step: 5,
    ...
    body: "Add your photo, your preferred side and your home club. A complete profile gets more match invites.",
    icon: "🎯",
  },
  {
    step: 6,
  ...
  },
  {
    ...
    route: null,
    title: "You're Ready.",
    body: "Your 100 XP welcome bonus is already in your account. Now go play.",
    icon: "🚀",
    isComplete: true,
  },
];
